...
window.addEventListener('mousemove', positionCursor);
  ...
  $("#div").hover(
    ...
    $('.dropdown-trigger').click(function(){
      $('.dropdown-menu').toggleClass('show'); // assuming you use a 'show' class to display
    });
...
var textarea = $('.term');
var typingSpeed = 10;
var text = 'look around';
var typingIndex = 0;
var outputIndex = 0;
var count = 0;
var output = ["okay", "checking files...", "system ok", "launching...", "complete"];
var time = 1;
...
function feedbacker() {
  textarea.append("[    " + count / 1000 + "] " + output[outputIndex] + "<br>");
  ...
  if (outputIndex < output.length) {
    setTimeout(function () {
      feedbacker();
    }, time * 300); // Slower, more readable output
  } else {
